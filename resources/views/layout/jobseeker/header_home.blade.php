...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ URL::asset('public/jQuery-Radiocharm/jquery-radiocharm.css') }}">
</head>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light tjnav-bar">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto my-2 my-lg-0 tnav-right tn-nav">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-secondary dropdown-toggle dropdown-profile1 header-menu-noti" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" style="width: 300px">
                            <a href="{{route('js_dasboard')}}" class="dropdown-item dr-pr-item1" type="button">
                                <div class="row">
                                    <div class="col-2">
                            ...
                            <a href="{{route('js_jobmana')}}" class="dropdown-item dr-pr-item1" type="button">
                                <div class="row">
                                    <div class="col-2">
                            ...
                            <a href="{{route('js_jobnotirc')}}" class="dropdown-item dr-pr-item1" type="button">
                                <div class="row">
                                    <div class="col-2">
                            ...
                            <a href="{{route('js_rcsee')}}" class="dropdown-item dr-pr-item1" type="button">
                                <div class="row">
                                    <div class="col-2">
                            ...
                            <a href="{{route('js_security')}}" class="dropdown-item dr-pr-item1" type="button">
                                <div class="row">
                                    <div class="col-2">
                            ...
                            <a href="{{route('js_logout')}}" class="dropdown-item dr-pr-item-ls1" type="button">
                                <div class="row">
                                    <div class="col-2">
