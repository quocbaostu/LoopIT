    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-2">
                <h1 class="h3 mb-0 text-gray-800">Cập nhật tài khoản quản trị viên</h1>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-md-12 mb-4">
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <form action="{{route('admin.update_admin_acc_post')}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <input type="hidden" name="id_qtv" value="{{$admin->id_qtv}}">
                                <div class="form-group row">
                                    <div class="col-6">
                                        <label>Email</label>
                                        <input type="email" name="email" value="{{$admin->email}}" class="form-control" placeholder="Nhập email . . .">
                                        @error('email')
                                ...
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <input type="password" name="matkhau_new" value="{{old('matkhau_new')}}" class="form-control" placeholder="Cấp mật khẩu mới(nếu muốn). . .">
                                        @error('matkhau_new')
                                        <div class="alert alert-danger form-control-user" role="alert">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="tenqtv" value="{{$admin->tenqtv}}" class="form-control" placeholder="Nhập tên quản trị viên . . .">
                                        @error('tenqtv')
                                        <div class="alert alert-danger form-control-user" role="alert">{{$message}}</div>
                                        @enderror
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <input type="number" name="sdt" value="{{$admin->sdt}}" class="form-control" placeholder="Nhập mật khẩu . . .">
                                        @error('sdt')
                                        <div class="alert alert-danger form-control-user" role="alert">{{$message}}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-6">
                                        ...
                                        <select name="chucvu" class="form-control">
                                            ...
                                            <option value="{{$value->id_chucvu}}" @if($admin->id_chucvu == $value->id_chucvu) selected @endif>{{$value->tenchucvu}}</option>
                                            @endforeach
                                        </select>
                                        @error('chucvu')
                                        <div class="alert alert-danger form-control-user" role="alert">{{$message}}</div>
