  ...
  <div class="container published-recuitment-content">
    <div class="row">
        ...
        <div class="col-md-8 col-sm-12 col-12  ">
            ...
            <form method="post" action="{{ route('recruiter.account_change_password_post') }}" class="recuitment-form recuitment-inner">
              {{ csrf_field() }}
                        ...
                        <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionExample">
                          <div class="card-body recuitment-body">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                      <input type="password" name="matkhau_old" value="{{ old('matkhau_old') }}" class="form-control" placeholder="Nhập mật khẩu hiện tại"/>
                                      @if(Session::get('msg_error') != null)
                                      <div class="alert alert-danger form-control-user" role="alert">{{Session::get('msg_error')}}</div>
                                      @endif
                                      @error('matkhau_old')
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-9 txtcheck">
                                      <input type="password" name="matkhau_new" value="{{ old('matkhau_new') }}" id="password" class="form-control" placeholder="Nhập mật khẩu mới"/>
                                      @error('matkhau_new')
                                      <div class="alert alert-danger form-control-user" role="alert">{{$message}}</div>
                                      @enderror
                                  </div>
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-9 txtcheck">
                                      <input type="password" name="matkhau_nhaplai_new" value="{{ old('matkhau_nhaplai_new') }}" id="confirm_password" class="form-control" placeholder="Nhập lại mật khẩu mới"/>
                                      @error('matkhau_nhaplai_new')
                                      <div class="alert alert-danger form-control-user" role="alert">{{$message}}</div>
                                      @enderror
                                      <div id='message' class="alert  form-control-user" role="alert" ></div>
                                  </div>
                              </div>
                          </div>
                        </div>
                ...
                <div class="rec-submit">
                    <button type="submit" class="btn-submit-recuitment ml-5" id="btnsubmit">
