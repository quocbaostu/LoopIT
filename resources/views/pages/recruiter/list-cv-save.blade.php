        ...
        <div class="col-md-8 col-sm-12 col-12  ">
            <div class="row mt-2 sizeh1 " style="width:950px;">
              <div class="col-md-4 col-4 col-sm-4 col-sm-4 col-lg-4 col-xs-4">
                <h4 class="font-italic font-weight-light text-white page-header p-1 pl-2 img-header" >CV ỨNG VIÊN ĐÃ LƯU</h4>
              </div>
                    ...
                    <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionExample">
                      <div class="card-body recuitment-body">
                        <table class="table table-hover" id="tblDV">
                            ...
                            <tbody>
                            @if($listCVDaLuu != null)
                                @foreach($listCVDaLuu as $key => $val)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($val->trangthaicv == 0 || $val->trangthaicv == 1)
                                        <a href="{{route('recruiter.remove_save_jobseeker_cv', ['id_cv' => $val->id_cv ])}}" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                        @elseif($val->trangthaicv != 0)
                                        <a class="btn btn-primary" href="{{route('recruiter.detail_cv_search', ['id_cv' => $val->id_cv ])}}"><i class="fa fa-list-ul" aria-hidden="true"></i></a> 
                                        <a href="{{route('recruiter.remove_save_jobseeker_cv', ['id_cv' => $val->id_cv ])}}" 
                            ...
                            <tfoot class="text-right">
                              <tr>
                                  <td colspan="5" class="text-right"><h5><strong class="font-weight-light">Chưa có CV nào được lưu</strong></h5></td>
                              </tr>
                            </tfoot>
                            @endif
                        </table>
