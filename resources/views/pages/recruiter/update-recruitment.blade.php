  ...
  <div class="container published-recuitment-content">
    <div class="row">
      ...
      <div class="col-md-8 col-sm-12 col-12 recuitment-inner">
        ...
        <form method="post" action="{{ route('recruiter.update_recruitment_post') }}"  class="recuitment-form recuitment-inner">
              {{ csrf_field() }}
              <input type="hidden" name="id_tintd" value="{{isset($tinTuyenDung) ? $tinTuyenDung->id_tintd : ''}}">
                      ...
                      <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                        <div class="card-body recuitment-body">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="tencongviec" value="{{old('tencongviec') ?? isset($tinTuyenDung) ? $tinTuyenDung->tencongviec : '' }}" class="form-control" placeholder="Nhập tên công việc">
                              @error('tencongviec')
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              ...
                              @if(isset($tinTuyenDung))
                                ...
                                window.addEventListener("load", function() {
                                    $('#jobGender').val(`{{ $tinTuyenDung->capbac }}`).change();
                                });
                                </script>
                              @endif
                            </div>
                            ...
                            <div class="col-sm-3">
                              ...
                              @if(isset($tinTuyenDung))
                                <script type="text/javascript">
                                window.addEventListener("load", function() {
                                    $('#natureWork').val(`{{ $tinTuyenDung->loaicongviec }}`).change();
                                });
                                </script>
                              @endif
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <input type="text" name="diadiemlamviec" value="{{old('diadiemlamviec') ?? isset($tinTuyenDung) ? $tinTuyenDung->diadiemlamviec : ''}}" class="form-control" placeholder="Nhập địa điểm làm việc">
                              ...
                              <select type="text" name="thanhpho" class="form-control" id="jobProvince">
                                ...
                                <option value="0">Chọn Tỉnh/Thành Phố</option>
                                  @foreach($thanhpho as $tp)
                                      @if($tp->tentp == $tinTuyenDung->thanhpho)
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              ...
                              @if(isset($tinTuyenDung))
                                <script type="text/javascript">
                                window.addEventListener("load", function() {
                                    $('#jobLevel').val(`{{ $tinTuyenDung->trinhdo }}`).change();
                                });
                                </script>
                              @endif
                            </div>
                            ...
                            <div class="col-sm-3">
                              ...
                              @if(isset($tinTuyenDung))
                                <script type="text/javascript">
                                window.addEventListener("load", function() {
                                    $('#jobExperience').val(`{{ $tinTuyenDung->kinhnghiem }}`).change();
                                });
                                </script>
                              @endif
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              ...
                              @if(isset($tinTuyenDung))
                                <script type="text/javascript">
                                window.addEventListener("load", function() {
                                    $('#jobSalary').val(`{{ $tinTuyenDung->mucluong_toithieu }}`).change();
                                });
                                </script>
                              @endif
                            </div>
                            ...
                            <div class="col-sm-4">
                              ...
                              @if(isset($tinTuyenDung))
                                <script type="text/javascript">
                                window.addEventListener("load", function() {
                                    $('#jobWorkTime').val(`{{ $tinTuyenDung->mucluong_toida }}`).change();
                                });
                                </script>
                              @endif
                            </div>
                          ...
                          <label class="col-sm-3 col-form-label text-right label">Ngành nghề<span style="color: red" class="pl-2">*</span></label>
                            <div class="col-sm-9">
                              <select type="text" name="nganhnghe[]" multiple="multiple" class="form-control" data-placeholder="Chọn Ngành Nghề" id="jobType">
                                @if(isset($tinTuyenDung))
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea type="text" name="motacongviec" class="form-control" id="txtarea1" rows="5">{{old('motacongviec') ?? isset($tinTuyenDung) ? $tinTuyenDung->motacongviec : ''}}</textarea>
                              @error('motacongviec')
                              <div class="alert alert-danger form-control-user" role="alert">{{$message}}</div>
                              @enderror
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea type="text" name="yeucaucongviec" class="form-control" id="txtarea2" rows="5">{{old('yeucaucongviec') ?? isset($tinTuyenDung) ? $tinTuyenDung->yeucaucongviec : ''}}</textarea>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea type="text" name="quyenloi" id="txtarea3" class="form-control" rows="5">{{old('quyenloi') ?? isset($tinTuyenDung) ? $tinTuyenDung->quyenloi : ''}}</textarea>
                              @error('quyenloi')
                              <div class="alert alert-danger form-control-user" role="alert">{{$message}}</div>
                              @enderror
                            </div>
