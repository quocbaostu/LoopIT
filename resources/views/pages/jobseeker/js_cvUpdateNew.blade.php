                                                                    ...
                                                                    <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                        <div  class="row">
                                                                            <div class="column" style="text-align: left;">
                                                                                ...
                                                                                <p style="font-size: 14px; line-height: 140%;padding-bottom:10px;"><span style="font-size: 16px; line-height: 22.4px;"><em style="font-size: 30px;"><span id="ngaysinh" style="line-height: 22.4px; font-size: 16px;"><i class="fa fa-calendar"></i> NGÀY SINH</span></em></span></p>
                                                                                <p style="font-size: 14px; line-height: 140%;padding-bottom:10px;"><span style="font-size: 16px; line-height: 22.4px;"><em style="font-size: 30px;"><span id="gioitinh" style="line-height: 22.4px; font-size: 16px;"><i class="fa fa-venus-mars"></i> GIỚI TÍNH</span></em></span></p>
                                                                                <p style="font-size: 14px; line-height: 140%;padding-bottom:10px;"><span style="font-size: 16px; line-height: 22.4px;"><em style="font-size: 30px;"><span id="sdt" style="line-height: 22.4px; font-size: 16px;"><i class="fa fa-phone-square"></i> SỐ ĐIỆN THOẠI</span></em></span></p>
                                                                                <p style="font-size: 14px; line-height: 140%;padding-bottom:10px;"><span style="font-size: 16px; line-height: 22.4px;"><em style="font-size: 30px;"><span id="diachi" style="line-height: 22.4px; font-size: 16px;"><i class="fa fa-location-arrow"></i> ĐỊA CHỈ</span></em></span></p>
                                                                                <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><em style="font-size: 30px;"><span id="thanhpho" style="line-height: 22.4px; font-size: 16px;"><i class="fa fa-building"></i> THÀNH PHỐ</span></em></span></p>
                                                                            </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 20px 10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                                ...
                                                                <div class="cv-content">
                                                                    <div class="row">
                                                                        <input class="form-comtrol cv-content-title " type="text" value="HỌC VẤN" name="tieude1" id="tieude1">
                                                                    </div>
                                                                    <textarea style="width: 100%" id="hocvan" name="chitiet1" class="chitiet">
                                                                        @foreach ($hocvan as $hv)
                                                                        <p>Học:&nbsp;<strong>{{$hv->chuyennganh}}&nbsp; -&nbsp;</strong>Tại:&nbsp;<strong>{{$hv->truong}}&nbsp;</strong></p>
                                                                        <p>Cấp bậc:&nbsp;<strong>{{$hv->bangcap}}</strong>&nbsp;- Thời gian:&nbsp;<strong>{{$hv->ngaybd}} - {{$hv->ngaykt}}</strong></p>
                                                                        {{-- <p><em>{{$hv->mota}}</em></p> --}}
                                                                        <hr />
                                                                        <p>&nbsp;</p>
                                                                        @endforeach
                                                                ...
                                                                <div class="cv-content">
                                                                    <div class="row">
                                                                        <input class="form-comtrol cv-content-title " type="text" value="KINH NGHIỆM" name="tieude2" id="tieude2">
                                                                    </div>
                                                                    <textarea style="width: 100%" id="kinhnghiem" name="chitiet2" class="chitiet">
                                                                        @foreach ($kinhnghiem as $kn)
                                                                        <p>Vị trí:&nbsp;<strong>{{$kn->chucdanh}}&nbsp;</strong>&nbsp;- Tại:&nbsp;<strong>{{$kn->congty}}&nbsp;</strong></p>
                                                                        <p>Thời gian:<strong>&nbsp;{{$kn->ngaybd}} - {{$kn->ngaykt}}</strong></p>
                                                                        {{-- <p><em>{{$kn->mota}}</em></p> --}}
                                                                        <hr />
                                                                        <p>&nbsp;</p>
                                                                        @endforeach
                                                                ...
                                                                <div class="cv-content">
                                                                    <div class="row">
                                                                        <input class="form-comtrol cv-content-title " type="text" value="NGOẠI NGỮ" name="tieude3" id="tieude3">
                                                                    </div>
                                                                    <textarea style="width: 100%" id="ngoaingu" name="chitiet3" class="chitiet">
                                                                        @foreach ($ngoaingu as $nn)
                                                                        <p>Ngôn ngữ:&nbsp;<strong>{{$nn->tenngoaingu}}&nbsp;</strong></p>
                                                                        <p>Mưc độ thành thạo:&nbsp;<strong>{{$nn->mucdo}}&nbsp;</strong></p>
                                                                        <hr />
                                                                        <p>&nbsp;</p>
                                                                        @endforeach
                                                                    </textarea>
