...
<head>
	<meta charset="UTF-8">
	<title>Xác nhận email - LoopIt</title>
		...
		<div class="login-header">
			<div class="w-login m-auto">
				<div class="login-logo">
					...
					<span class="login-breadcrumb"><em>/</em> Xác nhận email</span>
				</div>
					...
					<div class="col-md-6 col-sm-12 col-12 login-main-right">
                        <div class="login-wrap">
                            <div class="login-html">
                                ...
                                <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Xác nhận email</label>
                                <div class="login-frm">
                                    <form method="post" action="{{ route('js_postResendveri')}}">
                                        {{ csrf_field() }}
                                        <div class="group">
                                            <label for="user" class="label">Nhập Email cần xác nhận</label>
                                        ...
                                        @elseif(Session::get('message_verified') != null)
                                            <div class="alert alert-danger login-alert">
                                                Email đã được sử dụng!
                                            </div>
                                        @elseif(Session::get('message_outtime') != null)
                                            <div class="alert alert-danger login-alert">
                                                Email đã quá số lần nhận thư xác nhận!
                                            </div>
                                        @endif
                                        <div class="hr"></div>
                                        <div>
