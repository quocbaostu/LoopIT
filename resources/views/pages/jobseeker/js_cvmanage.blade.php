    ...
    <div class="container published-recuitment-content">
        <div class="col-sm-12">
            ...
            <div class="card mb-3 nav-tab-job">
                ...
                <div class="tabs">
                    <button class="tablinks active" data-electronic="cvfile">File CV cá nhân</button>
                    <a href="{{route('js_getcvonlmanage')}}" class="tablinks btn btn-light"  data-electronic="cvonline">CV online</a>
                </div>
                <div id="cvfile" class="tabcontent active">
                    <div class="row" style="height: 38px">
                        <a href="#" class="addfilecv-link" data-toggle="modal" data-target="#add-file-cv">
                            <i class="fa fa-cloud-upload" aria-hidden="true"></i>
                            <span>Tải lên file CV mới</span>
                        </a>
                    </div>
                    <div class="card-deck row">
                        <div class="card">
                            ...
                            <div class="small-card">
                                <div class="card-body">
                                    <div class="row" id="before-delete">
                                        <div class="col-8">
                                            ...
                                            <h6 class="small-card-content">{{$cv->tenfile}}</h6>
                                        ...
                                        <div class="col-1">
                                            <a href="{{ URL::asset('public/cv/'.$cv->tenfile) }}" class="small-card-edit-filecv" target="_blank">
                                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                            </a>
                                        </div>
                                        <div class="col-1">
                                            <a href="#"  class="small-card-edit-filecv" data-target="#edit-file-cv-{{ $cv->id_cv }}" data-toggle="modal">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                            </a>
                                        </div>
                                        <div class="col-1">
                                            <a href="{{route('js_getDownloadCV', ['id_cv'=>$cv->id_cv])}}"  class="small-card-edit-filecv">
                                                <i class="fa fa-download" aria-hidden="true"></i>
                                            </a>
                                        </div>
                                        <div class="col-1">
                                            @if($cv->trangthaicv == 2)
                                            <a href="#" class="small-card-edit-filecv" data-target="#delete-file-cv-pub-{{ $cv->id_cv }}" data-toggle="modal">
                                                <i class="fa fa-trash" aria-hidden="true"></i>
                                            </a>
                                            @else
                                            <a href="#" class="small-card-edit-filecv" data-target="#delete-file-cv-{{ $cv->id_cv }}" data-toggle="modal">
                                                <i class="fa fa-trash" aria-hidden="true"></i>
                                            </a>
                                            @endif
                                        </div>
                                ...
                                {{-- Modal delete cv --}}
                                <div class="modal fade" id="delete-file-cv-{{ $cv->id_cv }}" tabindex="-1" role="dialog" style="z-index: 10000">
                                 ...
                                 <div class="modal fade" id="delete-file-cv-pub-{{ $cv->id_cv }}" tabindex="-1" role="dialog" style="z-index: 10000">
                                    <div class="modal-dialog" role="document">
                                        <form method="POST" action="{{route('js_postdeletecv', ['id_cv'=>$cv->id_cv])}}">
                                            {{ csrf_field() }}
                                            <div class="modal-content ">
                                                <div class="modal-header modal-header-err">
                                                <h5 class="modal-title">LỖI XOÁ FILE CV</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                                </div>
                                                <div class="modal-body">
                                                    CV của bạn đang ở trạng thái
                                ...
                                {{-- Modal edit cv --}}
                                <div class="modal fade" id="edit-file-cv-{{ $cv->id_cv }}" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="exampleModalCenterTitle" style="z-index: 10000">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{route('js_postsettingcv', ['id_cv'=>$cv->id_cv])}}" enctype="multipart/form-data">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group" style="width :100%">
                                                            <input  type="text" class="form-control" value="{{$cv->tenfile}}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr>
                                ...
                                <script type="text/javascript">
                                    $(window).load(function(e) {
                                        $("#edit-file-cv-{{$cv->id_cv}}").modal('show');
                                    });
                                </script>
                                @endif
                                <script>
                            ...
                            <div class="card-body" style="background-image: url({{ URL::asset('public/img/jobseeker/empty/filecv.jpg')}})"></div>
                            @endif
                            <div>
                                {!! $lstcvfile->links() !!}
                            </div>
                ...
                <div id="cvonline" class="tabcontent">
                    <div class="card-deck row">
                        <div class="card">
...
{{-- Modal Add file CV--}}
<div class="modal fade" id="add-file-cv" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="exampleModalCenterTitle" style="z-index: 10000">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">TẢI LÊN FILE CV</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            <form method="POST" action="{{route('js_postuploadfilecv')}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="col-sm-12">
                    <div class="row mb-2">
                        <div class="form-group required" style="width :100%">
                            ...
                            <input type="text" class="form-control" name="tieudecv" value="{{old('tieudecv')}}">
                            <div class="edit-vali-error">
                                @foreach ($errors->get('tieudecv') as $message)
                                    <div class="error">{{$message}}</div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group required" style="width :100%">
                            <label class="control-label"> Chọn File CV</label>
                ...
                <hr>
                <div style="text-align: center">
                    <input value="1" name="trangthaicv" checked data-radiocharm-label="Tắt tìm kiếm" type="radio"
                        data-radiocharm-background-color="f52222" data-radiocharm-icon="eye-slash">
                    <input value="2" name="trangthaicv" data-radiocharm-label="Bật tìm kiếm" type="radio"
                        data-radiocharm-background-color="1bd411" data-radiocharm-icon="eye">
                    <h6 class="mt-2">Bật trạng thái để cho phép Nhà tuyển dụng dụng tìm kiếm đến CV của bạn</h6>
                    <small class="mt-2" style="font-style: italic">Ghi chú: Bạn cần hoàn thành cập nhật mục "Thông tin cá nhân" tại Trang Quản Lý Hồ Sơ để bật trạng thái cho phép tìm kiếm.</small>
                </div>
                <hr>
...
<script src="//ajax.aspnetcdn.com/ajax/jQuery/jquery-2.2.3.js" type="text/javascript"></script>
{{-- Validate form thêm File CV--}}
@if (Session::pull('errupfile') != null)
<script type="text/javascript">
    $(window).load(function(e) {
        $("#add-file-cv").modal('show');
    });
</script>
@endif
...
{{-- Thông báo lỗi bật trạng thái tìm kiếm --}}
@if(Session::pull('errstt'))
<script type="text/javascript">
    $(window).load(function(e) {
        $("#errstt").modal('show');
    });
...
@endif
{{-- Thông báo lỗi bật trạng thái tìm kiếm --}}
@if(Session::pull('errcvedit'))
<script type="text/javascript">
    $(window).load(function(e) {
        $("#errcvedit").modal('show');
    });
</script>
@endif
